#! /usr/bin/env python
#
# Copyright (C) 2013 Alexandre Abraham <abraham.alexandre@gmail.com>

descr = """Little visualization tools for 3D image in Python"""
...
DISTNAME = 'pynax'
DESCRIPTION = 'Visualization tools for 3D image in Python'
LONG_DESCRIPTION = open('README.rst').read()
MAINTAINER = 'Alexandre Abraham'
MAINTAINER_EMAIL = 'abraham.alexandre@gmail.com'
URL = 'http://www.github.com/AlexandreAbraham/pynax'
LICENSE = 'new BSD'
DOWNLOAD_URL = 'http://www.github.com/AlexandreAbraham/pynax'
VERSION = '0.1-git'
...
if __name__ == "__main__":
    ...
    if sys.version_info[0] == 3:
        ...
        print("Copying source tree into build/py3k for 2to3 transformation"
              "...")
        shutil.copytree(os.path.join(old_path, 'pynax'),
                        os.path.join(local_path, 'pynax'))
        import lib2to3.main
